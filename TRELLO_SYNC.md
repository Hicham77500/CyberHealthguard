...
> Généré automatiquement le 2026-05-29 12:39:46Z via `scripts/trello_update.py`.
...
| --- | --- | --- | --- | --- | --- | --- |
| CHG-27 | CHG-027 — Dashboard / Reporting (Sprint 4) | Unassigned | - | ⚪️ | - | Dashboard, Sprint-4 |
| CHG-28 | CHG-028 — Tests pytest pipeline complet (Sprint 4) | Unassigned | - | ⚪️ | - | Tests, Sprint-4 |
